<?
    ...
    $sql = "SELECT uid,CASE WHEN admin=0 THEN 'N' ELSE 'Y' END,lastname,firstname,phonenumber,email,addressline1,addressline2,city,state,login.zipcode FROM login,zips WHERE login.zipcode=zips.ZipCode ORDER BY lastname";
